...
class BytePool {
    ...
    static BytePool INSTANCE = new BytePool(INITIAL_VALUE * 12, FILE_BUFFER_SIZE, "File reader");
    static BytePool WORKING = new BytePool(INITIAL_VALUE * 20, FILE_BUFFER_SIZE * 2, "New line");
